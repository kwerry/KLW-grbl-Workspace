...
cprequire_test(["inline:com-chilipeppr-workspace-grbl-klw"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-grbl-klw", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-grbl-klw", // Make the id the same as the cpdefine id
