# com-chilipeppr-workspace-grbl-klw
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-grbl-klw |
| Name                  | Workspace / grbl |
| Description           | A ChiliPeppr Workspace grbl. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/kwerry/KLW-grbl-Workspace/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/kwerry/klw-grbl-workspace |
| Github URL            | http://github.com/kwerry/KLW-grbl-Workspace |
| Test URL              | https://preview.c9users.io/kwerry/klw-grbl-workspace/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/kwerry/KLW-grbl-Workspace/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-grbl-klw"], // the id you gave your workspace
      function(myWorkspaceGrblKlw) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / grbl just got loaded.", myWorkspaceGrblKlw);
        myWorkspaceGrblKlw.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-grbl-klw"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / grbl"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace grbl."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/kwerry/KLW-grbl-Workspace/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/kwerry/klw-grbl-workspace"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/kwerry/KLW-grbl-Workspace"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://klw-grbl-workspace-kwerry.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
